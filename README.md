...
### Executive overview
Headline KPIs, monthly sales trend, and category mix.

![Executive overview](Page_1.png)

### Store comparison
Sales ranking and the labour efficiency table behind Finding 1.

![Store comparison](Page_2.png)

### Labour
Scheduled versus actual hours by weekday, with overrun hours and cost.
